...
export const setClientTheme = (name) => {
  ...
  if (name === 'light') {
    return Byond.winset({
      ...
      'interface.background-color': 'none',
      'interface.text-color': '#000000',
      'discord.background-color': 'none',
      'discord.text-color': '#000000',
      'reportbug.background-color': 'none',
      'reportbug.text-color': '#000000',
  ...
  if (name === 'dark') {
    Byond.winset({
      ...
      'interface.background-color': '#494949',
      'interface.text-color': COLOR_DARK_TEXT,
      'reportbug.background-color': '#492020',
      'reportbug.text-color': COLOR_DARK_TEXT,
