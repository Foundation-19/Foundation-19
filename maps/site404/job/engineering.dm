/datum/job/chief_engineer
	...
	alt_titles = list("Station Architect")
...
/datum/job/eng
	...
	alt_titles = list("Maintenance Technician", "Engine Technician", "Damage Control Technician", "Electrician")
...
/datum/job/juneng
	...
	department_flag = ENG
	selection_color = "#5b4d20"
	supervisors = "the Senior Station Engineers and Chief Engineer"
	economic_power = 3
