/datum/map/site53
	...
	map_admin_faxes = list("Foundation Central Office", "UIU Central Office", "GOC Central Office", "Horizon Initiative Central Office", "Shark Punching Center Central Office")
