...
/obj/structure/closet/secure_closet/guncabinet/sidearm
	...
	req_access = list()
	req_one_access = list(access_securitylvl4,access_emergency_armory,access_securitylvl5,access_hop,access_ce,access_medicallvl5,access_sciencelvl5,access_senadv)
