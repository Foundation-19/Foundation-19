/datum/map/site53
	...
	emergency_shuttle_called_sound = sound(/AI/torch/abandonship.ogg', volume = 45)
	...
	command_report_sound = sound(/AI/announcer/commandreport.ogg', volume = 45)
	...
	grid_check_sound = sound(/AI/announcer/poweroff.ogg', volume = 150)

	grid_restored_message = "Site power will be restored at this time"
	grid_restored_sound = sound(/AI/announcer/poweron.ogg', volume = 150)
	...
	radiation_detected_sound = sound(/AI/torch/radiation.ogg', volume = 45)

	space_time_anomaly_sound = sound(/AI/torch/spanomalies.ogg', volume = 45)
	...
	unidentified_lifesigns_sound = sound(/AI/torch/aliens.ogg', volume = 45)

//	xenomorph_spawn_sound = sound(/AI/torch/aliens.ogg', volume = 45)

	electrical_storm_moderate_sound = sound(/AI/torch/electricalstormmoderate.ogg', volume = 45)
	electrical_storm_major_sound = sound(/AI/torch/electricalstormmajor.ogg', volume = 45)
/*
/datum/map/torch/level_x_biohazard_sound(bio_level)
	switch(bio_level)
		if(7)
			return sound(/AI/torch/outbreak7.ogg', volume = 45)
		else
			return sound(/AI/torch/outbreak5.ogg', volume = 45)
*/
