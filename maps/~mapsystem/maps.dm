...
/datum/map
	...
	var/access_modify_region = list(
		ACCESS_REGION_SECURITY = list(access_securitylvl5, access_change_ids),
		ACCESS_REGION_MEDBAY = list(access_medicallvl5, access_change_ids),
...
/datum/map/proc/default_internal_channels()
	return list(
		...
		num2text(COMM_FREQ)  = list(access_keyauth),
		num2text(ENG_FREQ)   = list(access_engineeringlvl2),
		num2text(MED_FREQ)   = list(access_medicallvl2),
		num2text(MED_I_FREQ) = list(access_medicallvl2),
		num2text(SEC_FREQ)   = list(access_securitylvl2),
		num2text(SEC_I_FREQ) = list(access_securitylvl2),
		num2text(SCI_FREQ)   = list(access_sciencelvl2),
		num2text(SUP_FREQ)   = list(access_logistics),
		num2text(SRV_FREQ)   = list(access_dclassjanitorial, access_dclassbotany),
