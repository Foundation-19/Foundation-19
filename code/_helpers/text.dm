...
/proc/pencode2html(t)
	...
	t = replacetext(t, "\[man\]", "<img src = man.png>")
	...
	t = replacetext(t, "\[dea\]", "<img src = dea.png>")
	t = replacetext(t, "\[int\]", "<img src = int.png>")
	t = replacetext(t, "\[trib\]", "<img src = trib.png>")
...
/proc/html2pencode(t)
	...
	t = replacetext(t, "<img src = ethics.png>", "\[ethics\]")
	...
	t = replacetext(t, "<img src = sci.png>", "\[sci\]")
	t = replacetext(t, "<img src = sec.png>", "\[sec\]")
	t = replacetext(t, "<img src = isd.png>", "\[isd\]")
	t = replacetext(t, "<img src = dea.png>", "\[dea\]")
	t = replacetext(t, "<img src = int.png>", "\[int\]")
	t = replacetext(t, "<img src = trib.png>", "\[trib\]")
	t = replacetext(t, "<img src = ungoc.png>", "\[goc\]")
	t = replacetext(t, "<img src = uiu.png>", "\[uiu\]")
	t = replacetext(t, "<img src = thi.png>", "\[thi\]")
	t = replacetext(t, "<img src = ar.png>", "\[ar\]")
	t = replacetext(t, "<img src = ci.png>", "\[ci\]")
	t = replacetext(t, "<img src = sh.png>", "\[sh\]")
	t = replacetext(t, "<img src = cotbg.png>", "\[cotbg\]")
