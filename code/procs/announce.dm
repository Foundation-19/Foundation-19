...
/var/datum/announcement/minor/minor_announcement = new(new_sound = /AI/commandreport.ogg',)
...
/datum/announcement/priority/command/New(do_log = 1, new_sound = /misc/notice2.ogg', do_newscast = 0)
