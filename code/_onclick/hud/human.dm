...
/datum/hud/human/FinalizeInstantiation(ui_style='icons/mob/screen1_White.dmi', ui_color = "#ffffff", ui_alpha = 255)
	...
	if(hud_data.has_m_intent)
		...
		using.set_name("movement method")
		using.icon = ui_style
	...
	if(hud_data.has_throw)
		...
		mymob.throw_icon.set_name("throw")
	...
	if(hud_data.has_internals)
		...
		mymob.internals.set_name("internal")
	...
	if(hud_data.has_pressure)
		...
		mymob.pressure.set_name("pressure")
	...
	if(hud_data.has_bodytemp)
		...
		mymob.bodytemp.set_name("body temperature")
	...
	if(target.isSynthetic())
		...
		mymob.nutrition_icon.set_name("nutrition")
		...
		mymob.hydration_icon.set_name("hydration")
	...
	if(hud_data.has_sanity)
		...
		mymob.sanity_icon.set_name("sanity")
	...
	if(hud_data.has_blink)
		...
		mymob.blink_icon.set_name("blink")
