...
#define DAM_BULLET    (1<<3)
#define DAM_EXPLODE   (1<<4)
#define DAM_DISPERSED (1<<5) // Makes apply_damage calls without specified zone distribute damage rather than randomly choose organ (for humans)
#define DAM_BIO       (1<<6) // Toxin damage that should be mitigated by biological (i.e. sterile) armor
