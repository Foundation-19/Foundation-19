...
#define ADMIN_SET_SD_CODE "(<a href='?_src_=holder;[HrefToken(forceGlobal = TRUE)];set_selfdestruct_code=1'>SETCODE</a>)"												// TODO
...
/atom/proc/Safe_COORD_Location()
	...
	var/turf/T = get_turf(A) //resolve where the thing is.
