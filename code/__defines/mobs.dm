...
#define SPECIES_SCP049      "SCP-049"
#define SPECIES_SCP106      "SCP-106"
#define SPECIES_SCP173      "SCP-173"
#define SPECIES_SCP999      "SCP-999"

#define UNRESTRICTED_SPECIES list(SPECIES_HUMAN)
#define RESTRICTED_SPECIES   list(SPECIES_VOX, SPECIES_ALIEN, SPECIES_GOLEM, SPECIES_DIONA, SPECIES_IPC, SPECIES_UNATHI, SPECIES_YEOSA, SPECIES_SKRELL, SPECIES_TRITONIAN, SPECIES_SPACER, SPECIES_VATGROWN, SPECIES_GRAVWORLDER, SPECIES_MULE)
