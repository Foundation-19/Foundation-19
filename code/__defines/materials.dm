...
#define MATERIAL_REINFORCED_CONCRETE     "concrete2"
#define MATERIAL_VERTICAL_CONCRETE       "vertical concrete"
#define MATERIAL_CONCRETE_TILES          "concrete tiles"
#define MATERIAL_CONCRETE_FOAM           "foamed cement"
