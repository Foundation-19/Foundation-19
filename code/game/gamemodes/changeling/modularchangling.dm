...
/datum/power/changeling/absorb_dna
	...
	genomecost = 0
	verbpath = TYPE_PROC_REF(/mob, changeling_absorb_dna)
...
/datum/power/changeling/lesser_form
	...
	genomecost = 4
	verbpath = TYPE_PROC_REF(/mob, changeling_lesser_form)
...
/datum/power/changeling/deaf_sting
	...
	genomecost = 1
	allowduringlesserform = 1
	verbpath = TYPE_PROC_REF(/mob, changeling_deaf_sting)
...
/datum/power/changeling/LSDSting
	...
	genomecost = 3
	verbpath = TYPE_PROC_REF(/mob, changeling_lsdsting)
...
/datum/power/changeling/DeathSting
	...
	genomecost = 10
	verbpath = TYPE_PROC_REF(/mob, changeling_DEATHsting)
...
/datum/power/changeling/Epinephrine
	...
	genomecost = 3
	verbpath = TYPE_PROC_REF(/mob, changeling_unstun)
...
/datum/power/changeling/ChemicalSynth
	...
	genomecost = 4
	isVerb = 0
	verbpath = TYPE_PROC_REF(/mob, changeling_fastchemical)
/*
...
/datum/power/changeling/rapidregeneration
	...
	genomecost = 7
	verbpath = TYPE_PROC_REF(/mob, changeling_rapidregen)
