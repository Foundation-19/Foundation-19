...
/obj/machinery/alarm
	...
	req_access = list(list(access_securitylvl1, access_engineeringlvl2, access_engineeringlvl2)) //access_securitylvl1 added since mapper air alarms have it configured.
	clicksound = "button"
	clickvol = 30
...
/obj/machinery/alarm/server/New()
	..()
	req_access = list(access_sciencelvl5, access_engineeringlvl2, access_engineeringlvl2)
