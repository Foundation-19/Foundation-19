...
/obj/item/disk/nuclear/Initialize()
	...
	RegisterSignal(src, COMSIG_MOVED, /obj/item/disk/nuclear/proc/check_z_level)

/obj/item/disk/nuclear/proc/check_z_level()
	if(!(istype(SSticker.mode, /datum/game_mode/nuclear)))
		UnregisterSignal(src, COMSIG_MOVED, /obj/item/disk/nuclear/proc/check_z_level)	// However, when we are certain unregister if necessary
		return
...
/obj/item/disk/nuclear/Destroy()
	UnregisterSignal(src, COMSIG_MOVED, /obj/item/disk/nuclear/proc/check_z_level)
	nuke_disks -= src
	if(!nuke_disks.len)
