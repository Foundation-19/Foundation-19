...
/obj/machinery/computer/message_monitor/interact(mob/living/user)
	...
	if(auth)
		...
		dat += " Server Power: <A href='byond://?src=\ref[src];active=1'>[src.linkedServer && src.linkedServer.active ? FONT_COLORED("green","\[On\]"):FONT_COLORED("red","\[Off\]")]</a></h4>"
	else
		dat += "<h4><dd><A href='byond://?src=\ref[src];auth=1'>&#09;<font color='red'>\[Unauthenticated\]</font></a>&#09;/"
		dat += " Server Power: <u>[src.linkedServer && src.linkedServer.active ? FONT_COLORED("green","\[On\]"):FONT_COLORED("red","\[Off\]")]</u></h4>"
