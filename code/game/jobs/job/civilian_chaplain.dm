...
/datum/job/chaplain/equip(mob/living/carbon/human/H, alt_title, ask_questions = TRUE)
	...
	spawn(0)
		...
		switch(lowertext(new_religion))
			if("christianity")
				B.set_name("The Holy Bible")
			if("satanism")
				B.set_name("The Unholy Bible")
			if("cthulu")
				B.set_name("The Necronomicon")
			if("islam")
				B.set_name("Quran")
			if("scientology")
				B.set_name(pick("The Biography of L. Ron Hubbard","Dianetics"))
			if("chaos")
				B.set_name("The Book of Lorgar")
			if("imperium")
				B.set_name("Uplifting Primer")
			if("toolboxia")
				B.set_name("Toolbox Manifesto")
			if("homosexuality")
				B.set_name("Guys Gone Wild")
			if("science")
				B.set_name(pick("Principle of Relativity", "Quantum Enigma: Physics Encounters Consciousness", "Programming the Universe", "Quantum Physics and Theology", "String Theory for Dummies", "How To: Build Your Own Warp Drive", "The Mysteries of Bluespace", "Playing God: Collector's Edition"))
			else
				B.set_name("The Holy Book of [new_religion]")
