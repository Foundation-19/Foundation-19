...
/datum/job/enlistedofficerlcz
	...
	alt_titles = list("LCZ Containment Response Agent" = /decl/hierarchy/outfit/job/security/lcz_recon, "LCZ Containment Response Guard" = /decl/hierarchy/outfit/job/security/lcz_recon, "LCZ Combat Medic" = /decl/hierarchy/outfit/job/security/lcz_medic, "LCZ Riot Control Guard" = /decl/hierarchy/outfit/job/security/lcz_riot, "LCZ Riot Control Agent" = /decl/hierarchy/outfit/job/security/lcz_riot, "LCZ Agent")
