...
/datum/job/ncoofficerlcz
	...
	alt_titles = list("LCZ Senior Containment Response Agent" = /decl/hierarchy/outfit/job/security/lcz_recontain, "LCZ Containment Response Sergeant" = /decl/hierarchy/outfit/job/security/lcz_recontain, "LCZ Senior Combat Medic" = /decl/hierarchy/outfit/job/security/lcz_medic, "LCZ Riot Control Sergeant" = /decl/hierarchy/outfit/job/security/lcz_riot, "LCZ Senior Riot Control Agent" = /decl/hierarchy/outfit/job/security/lcz_riot, "LCZ Senior Agent")
...
/datum/job/enlistedofficerlcz
	...
	alt_titles = list("LCZ Containment Response Agent" = /decl/hierarchy/outfit/job/security/lcz_recontain, "LCZ Containment Response Guard" = /decl/hierarchy/outfit/job/security/lcz_recontain, "LCZ Combat Medic" = /decl/hierarchy/outfit/job/security/lcz_medic, "LCZ Riot Control Guard" = /decl/hierarchy/outfit/job/security/lcz_riot, "LCZ Riot Control Agent" = /decl/hierarchy/outfit/job/security/lcz_riot, "LCZ Agent")
