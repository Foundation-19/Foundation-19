/datum/job/hos
	...
	req_admin_notify = 1
	economic_power = 10
	requirements = list("LCZ Zone Commander" = 300, "HCZ Zone Commander" = 300, "EZ Supervisor" = 300, EXP_TYPE_SECURITY = 1800)
	total_positions = 1
	spawn_positions = 1
...
/datum/job/ltofficerlcz
	...
	economic_power = 4
	requirements = list("LCZ Sergeant" = 600, EXP_TYPE_LCZ = 1500)
...
/datum/job/ltofficerhcz
	...
	supervisors = "the Guard Commander"
	economic_power = 4
	requirements = list("HCZ Sergeant" = 600, EXP_TYPE_HCZ = 1500)
	minimal_player_age = 10
	ideal_character_age = 30
...
/datum/job/ltofficerez
	...
	supervisors = "the Guard Commander"
	economic_power = 4
	requirements = list("EZ Senior Agent" = 600, EXP_TYPE_ECZ = 1500)
	minimal_player_age = 10
...
/datum/job/ncoofficerlcz
	...
	economic_power = 4
	requirements = list("LCZ Guard" = 600, EXP_TYPE_LCZ = 720)
...
/datum/job/ncoofficerhcz
	...
	economic_power = 4
	requirements = list("HCZ Guard" = 600, EXP_TYPE_HCZ = 720)
...
/datum/job/ncoofficerez
	...
	economic_power = 4
	requirements = list("EZ Agent" = 600, EXP_TYPE_ECZ = 720)
...
/datum/job/enlistedofficerhcz
	...
	economic_power = 4
	requirements = list(EXP_TYPE_ECZ = 300)
...
/datum/job/enlistedofficerez
	...
	economic_power = 4
	requirements = list(EXP_TYPE_LCZ = 300)
