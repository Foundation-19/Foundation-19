...
/datum/antagonist/deathsquad/mercenary/equip(mob/living/carbon/human/player)
	...
	player.equip_to_slot_or_store_or_drop(new /obj/item/clothing/under/syndicate(player), slot_w_uniform)
	...
	player.equip_to_slot_or_store_or_drop(new /obj/item/clothing/mask/gas/syndicate(player), slot_wear_mask)
	player.equip_to_slot_or_store_or_drop(new /obj/item/storage/box(player), slot_in_backpack)
	player.equip_to_slot_or_store_or_drop(new /obj/item/ammo_magazine/box/pistol(player), slot_in_backpack)
	player.equip_to_slot_or_store_or_drop(new /obj/item/rig/merc(player), slot_back)
