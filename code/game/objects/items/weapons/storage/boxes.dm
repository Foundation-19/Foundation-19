...
/obj/item/storage/box/aluminum
	name = "aluminum box"
	desc = "The aluminum lining prevents illicit items inside from being detected by metal detectors."
	foldable = /obj/item/stack/material/aluminium

/obj/item/storage/box/aluminum/has_contraband()
	return FALSE
