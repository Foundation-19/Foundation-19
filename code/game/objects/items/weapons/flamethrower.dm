...
/obj/item/flamethrower/proc/toggle_igniter(mob/user)
	...
	lit = !lit
	if(lit)
		playsound(loc, 'sounds/items/welderactivate.ogg', 50, TRUE)
		START_PROCESSING(SSobj, src)
	else
		playsound(loc, 'sounds/items/welderdeactivate.ogg', 50, TRUE)
		STOP_PROCESSING(SSobj,src)
	if(lit)
...
/obj/item/flamethrower/proc/flame_turf(list/turflist)
	...
	if(power < REQUIRED_POWER_TO_FIRE_FLAMETHROWER)
		...
		playsound(src, 'sounds/weapons/guns/flamethrower/flamethrower_empty.ogg', 50, TRUE, -3)
		return
	playsound(src, pick('sounds/weapons/guns/flamethrower/flamethrower1.ogg','sounds/weapons/guns/flamethrower/flamethrower2.ogg','sounds/weapons/guns/flamethrower/flamethrower3.ogg' ), 50, TRUE, -3)
