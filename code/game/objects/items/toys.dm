...
/obj/item/toy/crossbow/afterattack(atom/target as mob|obj|turf|area, mob/user as mob, flag)
	...
	if (locate (/obj/structure/table, src.loc))
		...
		D.SetName("foam dart")
		playsound(user.loc, /items/syringeproj.ogg', 50, 1)
...
/obj/item/toy/sword/attack_self(mob/user as mob)
	...
	if (src.active)
		...
		playsound(user, /weapons/saberon.ogg', 50, 1)
		src.icon_state = "swordblue"
		src.item_state = "swordblue"
		src.w_class = ITEM_SIZE_HUGE
	else
		to_chat(user, SPAN_NOTICE("You push the plastic blade back down into the handle."))
		playsound(user, /weapons/saberoff.ogg', 50, 1)
...
/obj/item/toy/snappop/throw_impact(atom/hit_atom)
	...
	playsound(src, /effects/snap.ogg', 50, 1)
	qdel(src)
...
/obj/item/toy/bosunwhistle/attack_self(mob/user as mob)
	if(cooldown < world.time - 35)
		...
		playsound(user, /misc/boatswain.ogg', 20, 1)
		cooldown = world.time
...
/obj/item/toy/prize/attack_self(mob/user as mob)
	if(cooldown < world.time - 8)
		...
		playsound(user, /mecha/mechstep.ogg', 20, 1)
		cooldown = world.time
...
/obj/item/toy/prize/attack_hand(mob/user as mob)
	if(loc == user)
		if(cooldown < world.time - 8)
			to_chat(user, SPAN_NOTICE("You play with [src]."))
			playsound(user, /mecha/mechturn.ogg', 20, 1)
			cooldown = world.time
			return
	..()
...
/obj/structure/plushie/attack_hand(mob/user)
	playsound(src.loc, /effects/rustle1.ogg', 100, 1)
...
/obj/item/toy/desk
	...
	var/on = 0
	var/activation_sound = /effects/flashlight.ogg'
