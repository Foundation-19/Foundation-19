...
/obj/item/device/encryptionkey/heads/captain
	...
	channels = list("Command" = 1, "Engineering" = 0, "Science" = 0, "Medical" = 0, "Supply" = 0, "Service" = 0, "HCZ-Security" = 1, "LCZ-Security" =1, "ECZ-Security" = 1)
...
/obj/item/device/encryptionkey/heads/hos
	...
	channels = list("Command" = 1, "HCZ-Security" = 1, "LCZ-Security" =1, "ECZ-Security" = 1)
...
/obj/item/device/encryptionkey/heads/hop
	...
	channels = list("Supply" = 1, "Service" = 1, "Command" = 1, "HCZ-Security" = 1, "LCZ-Security" =1, "ECZ-Security" = 1)
...
/obj/item/device/encryptionkey/ert
	...
	channels = list("Response Team" = 1, "Science" = 1, "Command" = 1, "Medical" = 1, "Engineering" = 1, "Supply" = 1, "Service" = 1, "HCZ-Security" = 1, "LCZ-Security" =1, "ECZ-Security" = 1)
