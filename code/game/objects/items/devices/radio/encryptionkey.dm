...
/obj/item/device/encryptionkey/headset_secsci
	name = "security research radio encryption key"
	icon_state = "medsci_cypherkey"
	channels = list("ECZ-Security" = 1, "Science" = 1)
...
/obj/item/device/encryptionkey/heads/hop
	...
	channels = list("Supply" = 1, "Service" = 1, "Command" = 1, "Security" = 0, "Hailing" = 1, "HCZ-Security" = 1, "LCZ-Security" =1, "ECZ-Security" = 1)
...
/obj/item/device/encryptionkey/ert
	...
	channels = list("Response Team" = 1, "Science" = 1, "Command" = 1, "Medical" = 1, "Engineering" = 1, "Security" = 1, "Supply" = 1, "Service" = 1, "Hailing" = 1, "HCZ-Security" = 1, "LCZ-Security" =1, "ECZ-Security" = 1)
