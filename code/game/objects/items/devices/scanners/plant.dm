...
/obj/item/device/scanner/plant
	...
	icon_state = "hydro"
	item_state = "analyzer"
	scan_sound = 'sounds/effects/fastbeep.ogg'
...
/proc/plant_scan_results(obj/target)
	...
	if(grown_seed.get_trait(TRAIT_BIOLUM))
		dat += "<br>It is [grown_seed.get_trait(TRAIT_BIOLUM_COLOUR)  ? FONT_COLORED("[grown_seed.get_trait(TRAIT_BIOLUM_COLOUR)]","bio-luminescent") : "bio-luminescent"]."
