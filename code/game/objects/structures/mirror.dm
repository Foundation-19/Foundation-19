...
/obj/structure/mirror/bullet_act(obj/item/projectile/Proj)
	...
	if(prob(Proj.get_structure_damage() * 2))
		if(!shattered)
			...
			playsound(src, /effects/hit_on_shattered_glass.ogg', 70, 1)
	..()

/obj/structure/mirror/attackby(obj/item/I as obj, mob/user as mob)
	if(shattered)
		playsound(src.loc, /effects/hit_on_shattered_glass.ogg', 70, 1)
		return
	...
	if(prob(I.force * 2))
		...
		playsound(src.loc, /effects/Glasshit.ogg', 70, 1)
