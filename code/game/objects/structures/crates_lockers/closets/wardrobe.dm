...
/obj/structure/closet/wardrobe/suit/New()
	..()
	new /obj/item/clothing/under/suit/charcoal(src)
	new /obj/item/clothing/under/suit/navy(src)
	new /obj/item/clothing/under/suit/burgundy(src)
	new /obj/item/clothing/under/suit/checkered(src)
	new /obj/item/clothing/under/suit/tan(src)
	new /obj/item/clothing/under/sl_suit(src)
	new /obj/item/clothing/under/suit(src)
	new /obj/item/clothing/under/suit/skirt(src)
	new /obj/item/clothing/under/suit/really_black(src)
	new /obj/item/clothing/under/suit/red(src)
