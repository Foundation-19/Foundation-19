...
/datum/trader/proc/offer_money_for_trade(trade_num, money_amount, turf/location, skill = SKILL_MAX)
...
/datum/trader/proc/trade(list/offers, num, turf/location)
	...
	playsound(location, 'sounds/effects/teleport.ogg', 75, 1)
	sparks(3, 1, location)
...
/datum/trader/proc/sell_items(list/offers, skill = SKILL_MAX)
	...
	playsound(get_turf(offers[1]), 'sounds/effects/teleport.ogg', 75, 1)
