...
/client/proc/receive_looc(client/C, commkey, message, prefix)
	...
	if(prefix)
		prefix = "\[[prefix]\] "
	return SPAN_CLASS("ooc","<span class='looc'>" + create_text_tag("looc", "LOOC:", src) + " <span class='prefix'>[prefix]</span><EM>[display_name][admin_stuff]:</EM> <span class='message'>[message]</span></span>")
