...
/obj/structure/noticeboard/anomaly/Initialize()
	...
	P.set_name("Memo RE: proper analysis procedure")
	...
	P = new()
	P.set_name("Memo RE: materials gathering")
	...
	P = new()
	P.set_name("Memo RE: ethical quandaries")
	...
	P = new()
	P.set_name("READ ME! Before you people destroy any more samples")
	...
	P = new()
	P.set_name("Reminder regarding the anomalous material suits")
