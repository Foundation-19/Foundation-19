...
/obj/structure/noticeboard/anomaly/Initialize()
	...
	P.("Memo RE: proper analysis procedure")
	...
	P = new()
	P.("READ ME! Before you people destroy any more samples")
	...
	P = new()
	P.("Reminder regarding the anomalous material suits")
