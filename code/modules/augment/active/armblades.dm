...
//THESE ARE THE WEAPONS THEMSELVES
...
/obj/item/material/armblade/dropped() //since nodrop is fucked this will deal with it for now.
	..()
	spawn(1) if(src) qdel(src)
	
/obj/item/material/armblade/add_blood(mob/living/carbon/human/M) //No blood for some reason???
	return FALSE
