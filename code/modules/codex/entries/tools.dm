/datum/codex_entry/wrench
	...
	mechanics_text = "This versatile tool is used for dismantling machine frames, anchoring or unanchoring heavy objects \
	like vending machines and <span codexlink='emitter'>emitters</span>, and much more.<br>\
	In general, if you want something to move or stop moving entirely, you ought to use a wrench on it."
...
/datum/codex_entry/wirecutters
	...
	mechanics_text = "This tool will cut wiring anywhere you see it - make sure to wear insulated gloves! When used on more complicated machines or airlocks, \
...
/datum/codex_entry/welder
	...
	Click on an object to try to weld it. You can seal airlocks, attach heavy-duty machines like <span codexlink='emitter'>emitters</span> and disposal chutes, \
	and repair damaged <span codexlink='wall'>walls</span> - these are only a few of its uses.\
	<br>Each use of the welder will consume a unit of fuel. Be sure to wear protective equipment such as goggles, a mask, or certain voidsuit helmets to prevent eye damage.<br>\
...
/datum/codex_entry/crowbar
	...
	mechanics_text = "Crowbars have countless uses: click on floor tiles to pry them loose. Use alongside a <l>screwdriver</l> to install or remove windows. \
...
/datum/codex_entry/toolbelt
	...
	<l>screwdriver</l>, <l>crowbar</l>, <l>wrench</l>, <l>welder</l>, cable coil, and <l>multitool</l>. \
	Simply click the belt to move a tool to one of its slots."
	lore_text = "Good hide is hard to come by in third-world countries. When they can't come across it, \
	the Logistics department will outfit the staff with toolbelts made of synthetic leather."
...
/datum/codex_entry/paint_sprayer
	...
	mechanics_text = "Used to paint floors, <span codexlink='wall'>walls</span>, windows, pipes, mech parts and airlocks.\
...
/datum/codex_entry/multitool
	...
	Configuring and linking machinery usually requires a multitool as well"
