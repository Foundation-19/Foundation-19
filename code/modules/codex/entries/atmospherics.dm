/datum/codex_entry/atmos_pipe
	...
	entry_text = "This pipe, and all other pipes, can be connected or disconnected by a <l>wrench</l>.  The internal pressure of the pipe must \
...
/datum/codex_entry/atmos_he
	...
	entry_text = "This radiates heat from the pipe's gas to space, cooling it down."
...
/datum/codex_entry/atmos_visible_scrub
	...
	entry_text = "This is a special 'scrubber' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
...
/datum/codex_entry/atmos_visible_supply
	...
	entry_text = "This is a special 'supply' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
	a Universal Adapter pipe."
...
/datum/codex_entry/atmos_visible_universal
	...
	entry_text = "This allows you to connect 'normal' pipes, red 'scrubber' pipes, and blue 'supply' pipes."
...
/datum/codex_entry/atmos_manifold
	...
	entry_text = "A normal pipe with three ends to connect to."
...
/datum/codex_entry/atmos_manifold_manifold_four
	...
	entry_text = "This is a four-way pipe."
...
/datum/codex_entry/atmos_cap
	...
	entry_text = "This is a cosmetic attachment, as pipes currently do not spill their contents into the air."

//T-shaped valves
/datum/codex_entry/atmos_tvalve
	associated_paths = list(/obj/machinery/atmospherics/tvalve)
	entry_text = "Click this to toggle the mode.  The direction with the green light is where the gas will flow."

//Normal valves
/datum/codex_entry/atmos_valve
	associated_paths = list(/obj/machinery/atmospherics/valve)
	entry_text = "Click this to turn the valve.  If red, the pipes on each end are seperated.  Otherwise, they are connected."
...
/datum/codex_entry/atmos_shutoff
	...
	entry_text = "<p>This valve automatically closes itself when a leak is detected in the connected pipe network.</p>\
...
/datum/codex_entry/atmos_circulator
	...
	entry_text = "This generates electricity, depending on the difference in temperature between each side of the machine.  The meter in \
...
/datum/codex_entry/atmos_gate
	...
	entry_text = "This is a one-way regulator, allowing gas to flow only at a specific pressure and flow rate.  If the light is green, it is flowing."
...
/datum/codex_entry/atmos_pump
	...
	entry_text = "This moves gas from one pipe to another.  A higher target pressure demands more energy.  The side with the red end is the output."

//Vents
/datum/codex_entry/atmos_vent_pump
	associated_paths = list(/obj/machinery/atmospherics/unary/vent_pump)
	entry_text = "This pumps the contents of the attached pipe out into the atmosphere, if needed.  It can be controlled from an Air Alarm."

//Freezers
/datum/codex_entry/atmos_freezer
	associated_paths = list(/obj/machinery/atmospherics/unary/freezer)
	entry_text = "Cools down the gas of the pipe it is connected to.  It uses massive amounts of electricity while on. \
...
/datum/codex_entry/atmos_heater
	...
	entry_text = "Heats up the gas of the pipe it is connected to.  It uses massive amounts of electricity while on. \
	It can be upgraded by replacing the capacitors, manipulators, and matter bins.  It can be deconstructed by screwing the maintenance panel open with a \
	screwdriver, and then using a crowbar."
...
/datum/codex_entry/atmos_injector
	...
	entry_text = "Outputs the pipe's gas into the atmosphere, similar to an airvent.  It can be controlled by a nearby atmospherics computer. \
...
/datum/codex_entry/atmos_vent_scrubber
	...
	entry_text = "This filters the atmosphere of harmful gas.  Filtered gas goes to the pipes connected to it, typically a scrubber pipe. \
...
/datum/codex_entry/atmos_omni_filter
	...
	entry_text = "Filters gas from a custom input direction, with up to two filtered outputs and a 'everything else' \
...
/datum/codex_entry/atmos_omni_mixer
	...
	entry_text = "Combines gas from custom input and output directions.  The percentage of combined gas can be defined."
...
/datum/codex_entry/atmos_canister
	...
	entry_text = "These metal canisters hold large amounts of gas under pressure. <span codexlink='tank'>Tanks of gas</span> (the kind you can hold in your hand) \
...
/datum/codex_entry/atmos_power_pump
	...
	entry_text = "Invaluable for filling air in a room rapidly after a breach repair.  The internal gas container can be filled by \
...
/datum/codex_entry/atmos_power_scrubber
	...
	entry_text = "Filters the air, placing harmful gases into the internal gas container.  The container can be emptied by \
	connecting it to a connector port.  The pump can pump the air in (sucking) or out (blowing), at a specific target pressure.  The power cell inside can be \
...
/datum/codex_entry/atmos_meter
	...
	entry_text = "Measures the volume and temperature of the pipe under the meter."

//Pipe dispensers
/datum/codex_entry/atmos_pipe_dispenser
	associated_paths = list(/obj/machinery/pipedispenser)
	entry_text = "This can be moved by using a <l>wrench</l>.  You will need to wrench it again when you want to use it.  You can put \
...
/datum/codex_entry/transfer_valve
	...
	entry_text = "This machine is used to merge the contents of two different <span codexlink='tank'>gas tanks</span>.<br>\
...
/datum/codex_entry/gas_tank
	...
	entry_text = "These tanks are utilised to store any of the various types of gaseous substances.<br>\
...
/datum/codex_entry/gas_analyzer
	...
	entry_text = "A device that analyzes the gas contents of a tile or atmospherics devices. Has 3 modes: Default operates without \
