/datum/codex_entry/jukebox
	...
	Use a <l>wrench</l> to attach or detach the jukebox to the floor. The room it is installed in must have power for it to operate!"
	...
	antag_text = "Slide a <l>cryptographic sequencer</l> into the jukebox to overload its speakers. Instead of music, it'll produce a hellish blast of noise and explode!"
