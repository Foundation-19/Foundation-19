/datum/codex_entry/baton
	...
	entry_text = "The baton needs to be turned on to apply the stunning effect. Use it in your hand to toggle it on or off. If your intent is \
...
/datum/codex_entry/energy_sword
	...
	entry_text = "The energy sword is a very strong melee weapon, capable of severing targetted limbs easily. It can also has a chance \
...
/datum/codex_entry/cultblade
	...
	entry_text = "This sword is a powerful weapon, capable of severing targetted limbs easily. Nonbelivers are unable to use this weapon."
