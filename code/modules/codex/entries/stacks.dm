/datum/codex_entry/telecrystal
	...
	entry_text = "Telecrystals can be activated by utilizing them on devices with an actively running uplink. They will not activate on unactivated uplinks."

/datum/codex_entry/rods
	associated_paths = list(/obj/item/stack/material/rods)
	entry_text = "Made from <span codexlink='steel'>steel sheets</span>. You can build a <l>grille</l> by using it in your hand. \
...
/datum/codex_entry/glass
	...
	entry_text = "Use in your hand to build a window. Can be upgraded to reinforced glass by adding <span codexlink='rod'>metal rods</span>, \
...
/datum/codex_entry/glass_reinf
	...
	entry_text = "Use in your hand to build a window. Reinforced glass is much stronger against damage.<br>\
...
/datum/codex_entry/steel
	...
	entry_text = "Use in your hand to bring up the recipe menu. If you have enough sheets, click on something on the list to build it.<br>\
