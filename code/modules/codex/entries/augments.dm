/datum/codex_entry/cbm
	...
	mechanics_text = "Compact bionic modules are one-use installers pre-loaded with medical software and an augment. \
	...
	CBMs don't come with their own painkillers, and like any surgery operation, it will be extremely painful without them. \
	It will do its best to seal the wounds it creates, but in the event of an interruption, you will likely be left with an open surgical incision.<br>\
	You can use a <l>crowbar</l> to lever the augment out of the CBM, but doing so will render the CBM itself permanently useless. \
	This might be useful if you have a collaborator that can safely install the augment in a more desirable way."
...
/datum/codex_entry/leukocyte_breeder
	...
	It's also popular among boosters and bionic aficionados due to its ability to lessen the body's rejection of new additions to it.<br>\
	The body requires some time to 'break in' the augment due to rapid changes in the immune system, \
	typically characterized by sneezing, coughing, fevers, and other symptoms of a minor cold. \
	These side effects fade quickly, from anywhere between a few minutes to a day or two. Once the body has broken in the system, \
	deactivating it will cause similar symptoms, as it has to adapt to the sudden lack of supplements it previously had."
...
/datum/codex_entry/internal_air_system
	...
	The sensation of having your lungs fill without breathing can take some time to get used to, though."
...
/datum/codex_entry/nerve_dampeners
	...
	Because of its haphazard methodology and unsafe mode of operation, it doesn't see much use in SolGov space."
