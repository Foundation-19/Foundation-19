/datum/codex_entry/modular_computer
	entry_text = "Modular computers are (as their name implies) assembled with different hardware items that, together, allow a modular computer to function.<br>\
...
/datum/codex_entry/processor_unit
	...
	entry_text = "A critical component for <span codexlink='Modular Computer'>modular computers</span>.<br>\
...
/datum/codex_entry/hard_drive_portable
	...
	entry_text = "A form of <l>hard drive</l> that allows for physical transportation of files.<br>\
...
/datum/codex_entry/battery_module
	...
	entry_text = "A semi-critical component for <span codexlink='Modular Computer'>modular computers</span>.<br>\
...
/datum/codex_entry/network_card
	...
	entry_text = "An optional component for <span codexlink='Modular Computer'>modular computers</span>.<br>\
