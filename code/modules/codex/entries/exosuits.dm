/datum/codex_entry/exosuits
	...
	entry_text = "An exosuit is a type of vehicle that can mount a variety of tools and equipment."

/datum/codex_entry/exosuit_equipment
	associated_paths = list(/obj/item/mech_equipment)
	entry_text = "Exosuit equipment is mounted onto specific exosuit hardpoints. In order to correctly attach itself, it will also need the exosuit to have the right software. \
...
/datum/codex_entry/exosuit_flash
	...
	entry_text = "An exosuit flash. Use it on someone to blind them or on itself to perform a weaker area blind."
