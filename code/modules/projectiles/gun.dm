...
/obj/item/gun
	...
	var/move_delay = 1
	var/fire_sound = /weapons/gunshot/gunshot.ogg'
	...
	var/selector_sound = /weapons/guns/selector.ogg'
...
/obj/item/gun/proc/handle_click_empty(mob/user)
	...
	playsound(src.loc, /weapons/empty.ogg', 100, 1)
...
/obj/item/gun/proc/toggle_safety(mob/user)
	...
	if(user)
		...
		last_safety_check = world.time
		playsound(src, /weapons/flipblade.ogg', 15, 1)
