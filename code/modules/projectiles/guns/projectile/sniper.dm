/obj/item/gun/projectile/heavysniper
	...
	load_sound = /weapons/guns/interaction/rifle_load.ogg'
	fire_delay = 12
...
/obj/item/gun/projectile/heavysniper/proc/unload_shell()
	if(chambered)
		if(!bolt_open)
			playsound(src.loc, /weapons/guns/interaction/rifle_boltback.ogg', 50, 1)
			bolt_open = 1
...
/obj/item/gun/projectile/heavysniper/attack_self(mob/user as mob)
	...
	if(bolt_open)
		...
		playsound(src.loc, /weapons/guns/interaction/rifle_boltforward.ogg', 50, 1)
		bolt_open = 0
