...
/obj/item/gun/projectile/pistol/throwback
	name = "pistol"
	desc = "A product of one of the worlds' hundreds of illicit workshops. These firearms, which are frequently reproductions of past handgun blueprints, are typically seen in the hands of smugglers and low-lifes."
