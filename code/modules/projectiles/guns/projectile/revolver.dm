/obj/item/gun/projectile/revolver
	...
	mag_insert_sound = /weapons/guns/interaction/rev_magin.ogg'
	mag_remove_sound = /weapons/guns/interaction/rev_magout.ogg'
	accuracy = 2
	accuracy_power = 8
	one_hand_penalty = 2
	bulk = 3
...
/obj/item/gun/projectile/revolver/verb/spin_cylinder()
	...
	playsound(src.loc, /weapons/revolver_spin.ogg', 100, 1)
