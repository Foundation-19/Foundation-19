/obj/item/ammo_casing
	...
	var/fall_sounds = list(/weapons/guns/casingfall1.ogg's/weapons/guns/casingfall2.oggds/weapons/guns/casingfall3.ogg')
...
/obj/item/ammo_magazine/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W, /obj/item/ammo_magazine/box))
		...
		L.update_icon()
		update_icon()
		playsound(src.loc, /weapons/bulletin_mag.wav', 80, 1)
	update_icon()
