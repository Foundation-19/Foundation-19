...
/obj/aiming_overlay/proc/aim_at(mob/target, obj/thing)
	...
	if(istype(aiming_with, /obj/item/gun))
		sound_to(aiming_at, sound(/weapons/TargetOn.ogg'))
		sound_to(owner, sound(/weapons/TargetOn.ogg'))
...
/obj/aiming_overlay/proc/cancel_aiming(no_message = 0)
	...
	if(!no_message)
		...
		if(istype(aiming_with, /obj/item/gun))
			sound_to(aiming_at, sound(/weapons/TargetOff.ogg'))
			sound_to(owner, sound(/weapons/TargetOff.ogg'))
