/decl/emote/audible/synth
	...
	emote_sound = /machines/twobeep.ogg'
...
/decl/emote/audible/synth/ping
	...
	emote_sound = /machines/ping.ogg'

/decl/emote/audible/synth/buzz
	key = "buzz"
	emote_message_3p = "buzzes."
	emote_sound = /machines/buzz-sigh.ogg'

/decl/emote/audible/synth/confirm
	key = "confirm"
	emote_message_3p = "emits an affirmative blip."
	emote_sound = /machines/synth_yes.ogg'

/decl/emote/audible/synth/deny
	key = "deny"
	emote_message_3p = "emits a negative blip."
	emote_sound = /machines/synth_no.ogg'
...
/decl/emote/audible/synth/security
	...
	emote_sound = /voice/biamthelaw.ogg'
