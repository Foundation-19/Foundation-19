...
/decl/cultural_info/location/human/earth
	...
	distance = "\[Redacted]"
	economic_power = null
	description = "The SCP Foundation owns Site-53, a top-secret, highly protected facility. It serves as a principal containment and study centre for anomalous things, beings, and phenomena known as SCPs. It is located at an undisclosed location. Site-53 is committed to defending the globe against the possible hazards presented by these enigmatic beings, using modern technology and expert staff."
