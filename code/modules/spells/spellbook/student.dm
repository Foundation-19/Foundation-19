...
/datum/spellbook/student
	name = "Applied Thaumatology"
	feedback = "ST"
	desc = "This book contains all you need to know about Thaumatic Workings, more commonly known as spells."
	...
	spells = list(/datum/spell/aimed/passage = 						1,
