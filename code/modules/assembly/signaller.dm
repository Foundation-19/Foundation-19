...
/obj/item/device/assembly/signaller/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return
...
/obj/item/device/assembly/signaller/tgui_data(mob/user)
	. = list()

	.["current_freq"] = frequency
	.["current_signal"] = code

/obj/item/device/assembly/signaller/tgui_static_data(mob/user)
	. = list()
