/obj/structure/chorus
	...
	var/death_sound = /effects/splat.ogg'
...
/obj/structure/chorus/proc/chorus_click(mob/living/carbon/alien/chorus/C)
	if(can_activate(C))
		activate(C)
...
/obj/structure/chorus/proc/can_activate(mob/living/carbon/alien/chorus/C, warning = TRUE)
	if(!owner)
		return FALSE
