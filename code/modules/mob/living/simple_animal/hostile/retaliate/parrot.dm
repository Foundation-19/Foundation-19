...
/mob/living/simple_animal/hostile/retaliate/parrot/Initialize()
	...
	add_verb(src, list(
		TYPE_PROC_REF(/mob/living/simple_animal/hostile/retaliate/parrot, steal_from_ground),
		TYPE_PROC_REF(/mob/living/simple_animal/hostile/retaliate/parrot, steal_from_mob),
		/mob/living/simple_animal/hostile/retaliate/parrot/verb/drop_held_item_player,
		TYPE_PROC_REF(/mob/living/simple_animal/hostile/retaliate/parrot, perch_player),
	))
	verbs.Add()
