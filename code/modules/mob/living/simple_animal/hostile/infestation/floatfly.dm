...
/mob/living/simple_animal/hostile/infestation/floatfly
	...
	death_sounds = list(/simple_mob/abominable_infestation/floatfly/death.ogg')
...
/obj/item/natural_weapon/claws/floatfly
	...
	hitsound = /weapons/alien_claw_flesh1.ogg'
...
/mob/living/simple_animal/hostile/infestation/floatfly/proc/StartFlight()
	if(!density || fly_cooldown >= world.time)
		return FALSE
	density = FALSE
	playsound(src, /simple_mob/abominable_infestation/floatfly/fly.ogg', 75, TRUE, 6)
