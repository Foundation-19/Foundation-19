/mob/living/simple_animal/hostile/infestation/broodling
	...
	death_sounds = list(/simple_mob/abominable_infestation/broodling/death.ogg')

/obj/item/natural_weapon/claws/broodling
	force = 7
	armor_penetration = 10
	hitsound = /weapons/slashmiss.ogg'
	attack_cooldown = 2
...
/datum/say_list/infestation_broodling
	...
	emote_hear_sounds = list(
		/simple_mob/abominable_infestation/broodling/ambient_1.ogg',
		/simple_mob/abominable_infestation/broodling/ambient_2.ogg',
		)
