...
/obj/item/natural_weapon/assembler
	...
	hitsound = /weapons/rapidslice.ogg'
	sharp = TRUE
	edge = TRUE
...
/mob/living/simple_animal/hostile/infestation/assembler/proc/ConsumeDead(mob/living/L)
	...
	playsound(src, /simple_mob/abominable_infestation/assembler/ambient_1.ogg', 50, TRUE)
	set_AI_busy(TRUE)
...
/mob/living/simple_animal/hostile/infestation/assembler/proc/AttemptLarva(forced_type = null)
	...
	L.color = color
	L.faction = faction
	playsound(L, /simple_mob/abominable_infestation/larva/spawn.ogg', rand(35, 50), TRUE)
