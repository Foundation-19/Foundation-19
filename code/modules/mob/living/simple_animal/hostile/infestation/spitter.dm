/mob/living/simple_animal/hostile/infestation/spitter
	...
	projectilesound = /weapons/alien_spit.ogg'
	...
	death_sounds = list(/simple_mob/abominable_infestation/spitter/death.ogg')

/obj/item/natural_weapon/bite/abomination_spitter
	hitsound = /simple_mob/abominable_infestation/spitter/attack.ogg'
...
/datum/say_list/infestation_spitter
	...
	emote_hear_sounds = list(
		/simple_mob/abominable_infestation/spitter/ambient_1.ogg',
		/simple_mob/abominable_infestation/spitter/ambient_2.ogg',
		)
