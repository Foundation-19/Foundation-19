/mob/living/simple_animal/hostile/infestation/eviscerator
	...
	movement_sound = /simple_mob/abominable_infestation/eviscerator/step.ogg'
	...
	death_sounds = list(
		/simple_mob/abominable_infestation/eviscerator/death_1.ogg',
		/simple_mob/abominable_infestation/eviscerator/death_2.ogg',
		)
...
/obj/item/natural_weapon/claws/strong/eviscerator
	...
	hitsound = /simple_mob/abominable_infestation/eviscerator/attack.ogg'
...
/datum/ai_holder/simple_animal/infestation/eviscerator
	...
	var/list/aggro_sounds = list(
		/simple_mob/abominable_infestation/eviscerator/aggro_1.ogg',
		/simple_mob/abominable_infestation/eviscerator/aggro_2.ogg',
		/simple_mob/abominable_infestation/eviscerator/aggro_3.ogg',
		)
