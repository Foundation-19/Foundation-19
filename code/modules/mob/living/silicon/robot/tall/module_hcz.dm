/obj/item/robot_module/tall/hcz
	name = "HCZ security module"
	...
	emag = /obj/item/gun/energy/gun/mounted/m16/mounted

/obj/item/robot_module/tall/hcz/respawn_consumable(mob/living/silicon/robot/R, amount)
	..()
