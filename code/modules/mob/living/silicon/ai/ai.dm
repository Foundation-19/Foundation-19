...
var/list/ai_verbs_default = list(
	...
	TYPE_PROC_REF(/mob/living/silicon/ai, ai_camera_list),
	TYPE_PROC_REF(/mob/living/silicon/ai, ai_goto_location),
	TYPE_PROC_REF(/mob/living/silicon/ai, ai_remove_location),
	...
	TYPE_PROC_REF(/mob/living/silicon/ai, ai_store_location),
	...
	TYPE_PROC_REF(/mob/living/silicon/ai, toggle_acceleration),
	TYPE_PROC_REF(/mob/living/silicon/ai, toggle_camera_light),
	TYPE_PROC_REF(/mob/living/silicon/ai, multitool_mode),
	...
	TYPE_PROC_REF(/mob/living/silicon/ai, ai_reset_radio_keys),
	TYPE_PROC_REF(/mob/living/silicon/ai, eye_puppet_toggle)
)
