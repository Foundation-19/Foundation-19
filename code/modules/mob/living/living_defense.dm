...
/mob/living/hitby(atom/movable/AM, datum/thrownthing/TT)
	...
	if(isliving(AM))
		var/mob/living/M = AM
		playsound(loc, /weapons/pierce.ogg', 25, 1, -1)
...
/mob/living/proc/turf_collision(turf/T, speed)
	...
	playsound(T, /effects/bangtaper.ogg', 50, 1, 1)//so it plays sounds on the turf instead, makes for awesome carps to hull collision and such
