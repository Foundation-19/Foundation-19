...
/mob/living/bot/secbot
	...
	var/list/threat_found_sounds = list(/voice/bcriminal.ogg',s/voice/bjustice.ogg'ds/voice/bfreeze.ogg')
	var/list/preparing_arrest_sounds = list(/voice/bfreeze.ogg')
