...
/mob/living/bot/secbot
	...
	maxHealth = 50
	health = 50
	req_access = list(list(access_securitylvl2))
	botcard_access = list(access_engineeringlvl2, access_securitylvl2, access_sciencelvl2, access_medicallvl2, access_maint_tunnels)
