...
/obj/structure/disposalpipe/proc/expel(obj/structure/disposalholder/H, turf/T, direction)
	...
	if(direction)		// direction is specified
		...
		playsound(src, /machines/hiss.ogg', 50, 0, 0)
		if(H)
			for(var/atom/movable/AM in H)
				AM.forceMove(T)
...
/obj/structure/disposalpipe/attackby(obj/item/I, mob/user)
	...
	if (isWelder(I))
		...
		if (!WT.isOn())
			...
			playsound(src, /items/Welder.ogg', 50, TRUE)
			...
			playsound(src, /items/Welder2.ogg', 50, TRUE)
			welded()
			return
		else
...
/obj/structure/disposalpipe/tagger/attackby(obj/item/I, mob/user)
	...
	if(istype(I, /obj/item/device/destTagger))
		...
		if(O.currTag)// Tag set
			sort_tag = O.currTag
			playsound(src.loc, /machines/twobeep.ogg', 100, 1)
...
/obj/structure/disposalpipe/trunk/attackby(obj/item/I, mob/user)
	...
	if(istype(I, /obj/item/weldingtool))
		...
		if(W.remove_fuel(0,user))
			playsound(src.loc, /items/Welder2.ogg', 100, 1)
