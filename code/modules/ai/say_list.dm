...
/datum/say_list/merc
	...
	threaten_sound = /weapons/TargetOn.ogg'
	stand_down_sound = /weapons/TargetOff.ogg'
...
/datum/say_list/malf_drone
	...
	threaten_sound = /effects/turret/move1.wav'
	stand_down_sound = /effects/turret/move2.wav'
