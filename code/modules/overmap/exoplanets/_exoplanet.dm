...
/area/exoplanet
	...
	ambience = list(
		/effects/wind/wind_2_1.ogg',
		/effects/wind/wind_2_2.ogg',
		/effects/wind/wind_3_1.ogg',
		/effects/wind/wind_4_1.ogg',
		/effects/wind/wind_4_2.ogg',
		/effects/wind/wind_5_1.ogg'
	)
