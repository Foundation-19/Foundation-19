...
/area/exoplanet/grass
	...
	ambience = list(/effects/wind/wind_2_1.ogg's/effects/wind/wind_2_2.oggds/effects/wind/wind_3_1.ognds/effects/wind/wind_4_1.ounds/ambience/eeriejungle2.ounds/ambience/eeriejungle1.ogg')
...
/area/exoplanet/grass/play_ambience(mob/living/L)
	...
	if(!L.ear_deaf && L.client && !L.client.ambience_playing)
		...
		L.playsound_local(get_turf(L),sound(/ambience/jungle.ogg', repeat = 1, wait = 0, volume = 25, channel = GLOB.ambience_sound_channel))
