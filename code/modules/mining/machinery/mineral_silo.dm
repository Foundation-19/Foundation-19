...
/obj/machinery/ore_silo/Initialize(mapload)
	...
	materials = AddComponent( \
		...
		container_signals = list( \
			COMSIG_MATCONTAINER_ITEM_CONSUMED = /obj/machinery/ore_silo.proc/log_item_consumed, \
			COMSIG_MATCONTAINER_SHEETS_RETRIEVED = /obj/machinery/ore_silo.proc/log_sheets_ejected, \
		), \
...
/obj/machinery/ore_silo/examine(mob/user)
	. = ..()
	to_chat(user, SPAN_NOTICE("[src] can be linked to circuit printers and protolathes with a multitool."))
