...
/obj/item/stock_parts/computer/hard_drive/proc/store_file(datum/computer_file/F)
	if(!try_store_file(F))
		return 0
	F.holder = src
	stored_files.Add(F)
...
/obj/item/stock_parts/computer/hard_drive/proc/can_store_file(size = 1)
...
/obj/item/stock_parts/computer/hard_drive/proc/try_store_file(datum/computer_file/F)
	if(!F || !istype(F))
		return 0
