...
/obj/item/clothing/suit/space/void
	...
	var/helmet_deploy_sound = /items/helmet_close.ogg'
	var/helmet_retract_sound = /items/helmet_open.ogg'
...
/obj/item/clothing/suit/space/void/verb/eject_tank()
	...
	H.put_in_hands(tank)
	src.tank = null
	playsound(loc, /effects/spray3.ogg', 50)
...
/obj/item/clothing/suit/space/void/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(isScrewdriver(W))
		...
		if(helmet || boots || tank)
			...
			playsound(loc, /items/Screwdriver.ogg', 50)
		...
		if(helmet)
			...
			src.helmet = W
			playsound(loc, /items/Deconstruct.ogg', 50, 1)
		return
...
/obj/item/clothing/suit/space/void/get_mob_overlay(mob/user_mob, slot)
	...
	if(tank && slot == slot_back)
		ret.add_overlay(tank.get_mob_overlay(user_mob, slot_back_str))
	return ret
