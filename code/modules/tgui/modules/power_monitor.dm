...
/datum/tgui_module/power_monitor/proc/refresh_sensors()
	...
	for(var/obj/machinery/power/sensor/S in SSmachines.machinery)
		if(T && (S.loc.z == T.z) || (S.loc.z in GLOB.using_map.station_levels) || (S.long_range)) // Consoles have range on their Z-Level. Sensors with long_range var will work between Z levels.
