...
GLOBAL_DATUM_INIT(notcontained_tgui_state, /datum/tgui_state/notcontained_state, new)

/datum/tgui_state/notcontained_state/can_use_tgui_topic(atom/src_object, mob/user)
