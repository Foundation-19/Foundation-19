...
/datum/instrument/fun/honk
	name = "!!HONK!!"
	id = "honk"
	samples = list("74"=/items/bikehorn.ogg') // Cluwne Heaven


/datum/instrument/fun/signal
	name = "Ping"
	id = "ping"
	samples = list("79"=/machines/ping.ogg')


/datum/instrument/fun/chime
	name = "Chime"
	id = "chime"
	samples = list("79"=/machines/chime.ogg')

/datum/instrument/fun/diona
	name = "Diona"
	id = "diona"
	samples = list("79"=/misc/nymphchirp.ogg'