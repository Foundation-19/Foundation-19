...
/datum/event/wormholes/announce()
	command_announcement.Announce("Topological anomalies have been detected near [station_name()].", "[station_name()] Sensor Array", new_sound = sound(/AI/spanomalies.ogg', volume=25))
