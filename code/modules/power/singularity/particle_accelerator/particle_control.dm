...
/obj/machinery/particle_accelerator/control_box/proc/add_strength(s)
	if(assembled)
		...
		if(strength > strength_upper_limit)
			...
			message_staff("PA Control Computer increased to [strength] by [ADMIN_LOOKUP(usr)] in [ADMIN_COORDJMP(src)]",0,1)
...
/obj/machinery/particle_accelerator/control_box/proc/remove_strength(s)
	if(assembled)
		...
		if(strength < 0)
			...
			message_staff("PA Control Computer decreased to [strength] by [ADMIN_LOOKUP(usr)] in [ADMIN_COORDJMP(src)]",0,1)
...
/obj/machinery/particle_accelerator/control_box/toggle_power()
	...
	message_staff("PA Control Computer turned [active ?"ON":"OFF"] by [ADMIN_LOOKUP(usr)] in [ADMIN_COORDJMP(src)]",0,1)
