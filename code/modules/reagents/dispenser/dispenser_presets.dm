...
/obj/machinery/chemical_dispenser/ert
	...
	disp_reagents = list(
		...
		"Arithrazine" = /datum/reagent/medicine/arithrazine,
		"Bicaridine" = /datum/reagent/medicine/bicaridine,
		"Chloral Hydrate" = /datum/reagent/chloral_hydrate,
		"Clonexadone" = /datum/reagent/medicine/cryogenic/clonexadone,
		"Cryoxadone" = /datum/reagent/medicine/cryogenic/cryoxadone,
		...
		"Imidazoline" = /datum/reagent/medicine/imidazoline,
		"Inaprovaline" = /datum/reagent/medicine/inaprovaline,
		"Kelotane" = /datum/reagent/medicine/kelotane,
		"Leporazine" = /datum/reagent/medicine/leporazine,
