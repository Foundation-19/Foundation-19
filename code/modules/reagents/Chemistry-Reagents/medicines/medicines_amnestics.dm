...
/datum/chemical_reaction/classd //VERY HARD TO MAKE AND DANGEROUS.
	...
	required_reagents = list(/datum/reagent/amnestics/classc = 1, /datum/reagent/chloral_hydrate = 10,/datum/reagent/mindbreaker_toxin = 5, /datum/reagent/impedrezene = 5)
