...
/datum/addiction/amnestics/WithdrawalStage1Process(mob/living/carbon/victim, delta_time)
	...
	if(prob(5) && nostalgia_cooldown >= world.time)
		...
		victim.playsound_local(get_turf(victim), /effects/nostalgia1.ogg', 10, FALSE)
...
/datum/addiction/amnestics/WithdrawalStage2Process(mob/living/carbon/victim, delta_time)
	...
	if(prob(7))
		...
		victim.playsound_local(get_turf(victim), pick(/effects/nostalgia2.ogg',s/effects/nostalgia3.ogg'), 25, FALSE)
...
/datum/addiction/amnestics/WithdrawalStage3Process(mob/living/carbon/victim, delta_time)
	...
	if(prob(9))
		...
		victim.playsound_local(get_turf(victim), pick(/effects/nostalgia4.ogg',s/effects/nostalgia5.ogg'), 50, FALSE)
...
/datum/addiction/amnestics/LoseAddiction(mob/living/carbon/victim)
	...
	victim.playsound_local(get_turf(victim), /effects/nostalgia5B.ogg', 50, FALSE)
