// analyze anomalies to get research points and shit
...
/obj/item/relic
	name = "strange object"
	desc = "What mysteries could this hold? Maybe the Science Department could find out."
...
/obj/item/relic/Initialize(mapload)
	. = ..()
	icon_state = pick("shock_kit","armor-igniter-analyzer","infra-igniter","infra-igniter-tank","prox-igniter","prox-multitool","prox-igniter-tank","radio-igniter","radio-igniter-tank","radio-multitool","radio-radio","timer-igniter","timer-multitool","timer-radio")
	realName = "[pick("broken","twisted","spun","improved","silly","regular","badly made")] [pick("device","object","toy","paratech","weapon")]"
...
/obj/item/relic/attack_self(mob/user)
	if(!revealed)
		to_chat(user, span_notice("You aren't quite sure what this is. Maybe Science knows what to do with it?"))
		return
...
/obj/item/relic/proc/rapidDupe(mob/user)
	...
	QDEL_LIST_IN(dupes, rand(1 SECOND, 10 SECONDS))
