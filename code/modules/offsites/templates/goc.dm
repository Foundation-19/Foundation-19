...
/decl/offsite_template/goc/generate_body(origin)
	var/text = {"\[table\]\[row\]\[cell\]\[center\]\[h1\]United Nations Global Occult Coalition\[/h1\]\[/center\]\[center\]\[goclogo\]\[/center\]\[center\]\[small\]\[i\]Survival. Concealment. Protection. Destruction. Education.
The Global Occult Coalition stands ready to defend humanity against all foes. Whether it likes it or not.\[/center\]\[/small\]\[/i\]\[row\]\[cell\]\[center\]\[h2\]PSYCHE General Transmission\[/h2\]\[h3\]\[time\], \[date\]\[/h3\]\[/center\]\[table\]
